  ...
  if (props.EditData !== null) {
    return (
      <div className="col-5 container border mt-5 p-3">
        <h4 className="text-start ">Update Post </h4>
        <div className="mb-3">
        ...
        <button type="submit" className="btn btn-primary" onClick={update_post}>
          Update Post
        </button>
      </div>
    );
    ...
    return (
      <div className="col-5 container border mt-5 p-3">
        ...
        <button type="submit" className="btn btn-primary" onClick={add_post}>
          Add Post
        </button>
      </div>
    );
