          ...
          return (
            <div className="col-7 m-auto container text-center border mt-4  p-2">
              ...
              <>
               ...
               <a className="fs-6 fw-bold ms-3" onClick={()=>deleteItem(i)}>Delete<i className="bi bi-trash3"></i></a>
               </>:<p></p>}
               </div>
              ...
              <div className="d-flex justify-content-between pe-5 ps-5 pt-3 "><p>{item.email}</p><p>{item.date}</p></div>
            </div>
          );
        })}
      </div>
