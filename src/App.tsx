...
function App() {
  ...
  return (
  <>
  <Navbar formDataArr={formDataArr} setFormArr={setFormArr} LoginArr={login} setLogin={setlogin}/>
  <Routes>
    <Route path='/' element={<Home arrBlog={arrBlog} setBlog={setBlog} LoginArr={login} setLogin={setlogin} EditData={editData} SetEdit={setEdit} setIndex={setIndex} index={index}/>}></Route>
    <Route path='/signup' element={<SignUp formDataArr={formDataArr} setFormArr={setFormArr}/>}/>
    <Route path="/signin" element={<SignIn formDataArr={formDataArr} setLogin={setlogin} LoginArr={login}/>}/>
    <Route path="/add_post" element={<AddPost  arrBlog={arrBlog} setBlog={setBlog} formDataArr={formDataArr}  EditData={editData} SetEdit={setEdit} setIndex={setIndex} index={index}/>}></Route>
  </Routes>
  <Footer/>
  </>
  );
